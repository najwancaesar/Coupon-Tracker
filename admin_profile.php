...
<head>
    ...
    <title>Profil Admin - Sistem Kupon</title>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link fw-semibold" href="admin_monitoring.php"><i class="fa-solid fa-desktop"></i> Monitoring Aktivitas</a></li>
                    <li class="nav-item"><a class="nav-link active fw-semibold" href="admin_profile.php"><i class="fa-solid fa-user"></i> Profile</a></li>
            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="card card-custom p-0 mb-4">
                    ...
                    <div class="profile-header">
                        ...
                        <p class="mb-0 text-white-50 fw-semibold"><i class="fa-solid fa-briefcase me-1"></i> <?= htmlspecialchars($status_pekerjaan) ?> (Administrator)</p>
                    </div>
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="info-label"><i class="fa-solid fa-id-card me-1"></i> <?= ($status_pekerjaan === 'Karyawan') ? 'NIP' : 'NIM' ?> / Username</div>
                        ...
                        <!-- Form Ganti Password -->
                        <h5 class="fw-bold mb-4" style="color: var(--primary-blue);"><i class="fa-solid fa-lock me-2"></i> Ganti Password Administrator</h5>
                        ...
                        <form action="proses_edit_password.php" method="POST">
                            ...
                            <button type="submit" class="btn btn-warning w-100 py-3 shadow-sm rounded-pill fw-bold text-dark">
